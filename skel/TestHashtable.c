...
int main() {
	...
	/* Put si get_key pentru o singura cheie. */
	put(ht_prieteni, "Alexandra", strlen("Alexandra") + 1, &informatii_prieteni[0], sizeof(informatii_prieteni[0]));
	p_infoPrieten = get_key(ht_prieteni, "Alexandra");
	printf("# 1\n");
	printf("Output:\n");
	...
	/* Put si get_key pentru chei unice. */
	put(ht_prieteni, "Alin", strlen("Alin") + 1, &informatii_prieteni[1], sizeof(informatii_prieteni[1]));
	put(ht_prieteni, "Loredana", strlen("Loredana") + 1, &informatii_prieteni[3], sizeof(informatii_prieteni[3]));
	...
	p_infoPrieten = get_key(ht_prieteni, "Alin");
	printf("\n# 3\n");
	printf("Output:\n");
	print_prieten(p_infoPrieten);
	printf("Output asteptat:\n");
	...
	p_infoPrieten = get_key(ht_prieteni, "Loredana");
	printf("\n# 4\n");
	printf("Output:\n");
	print_prieten(p_infoPrieten);
	printf("Output asteptat:\n");
	...
	put(ht_prieteni, "Alexandru", strlen("Alexandru") + 1, &informatii_prieteni[2], sizeof(informatii_prieteni[2]));

	p_infoPrieten = get_key(ht_prieteni, "Alexandru");
	printf("\n# 7\n");
	printf("Output:\n");
	print_prieten(p_infoPrieten);
	printf("Output asteptat:\n");
	...
	remove_ht_entry(ht_prieteni, "Alexandru");
	...
	/* Put si get_key chei unice. */
	current_key = 20;
	put(ht_prieteni, &current_key, sizeof(current_key), &informatii_prieteni[0], sizeof(informatii_prieteni[0]));
	current_key = 21;
	put(ht_prieteni, &current_key, sizeof(current_key), &informatii_prieteni[1], sizeof(informatii_prieteni[1]));
	current_key = 22;
	put(ht_prieteni, &current_key, sizeof(current_key), &informatii_prieteni[2], sizeof(informatii_prieteni[2]));

	current_key = 20;
	p_infoPrieten = get_key(ht_prieteni, &current_key);
	printf("\n# 10\n");
	printf("Output:\n");
	print_prieten(p_infoPrieten);
	printf("Output asteptat:\n");
	...
	/* Put pentru actualizare intrare de la cheie deja existenta. */
	current_key = 21;
	put(ht_prieteni, &current_key, sizeof(current_key), &informatii_prieteni[3], sizeof(informatii_prieteni[3]));
	p_infoPrieten = get_key(ht_prieteni, &current_key);
	printf("\n# 12\n");
	printf("Output:\n");
	print_prieten(p_infoPrieten);
